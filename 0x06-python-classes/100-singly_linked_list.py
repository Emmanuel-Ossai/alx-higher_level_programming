...
Node: Represent a node in a singly-linked list.
SinglyLinkedList: Represent a singly-linked list.
"""
...
def data(self, value):
    ...
    Args:
        value (int): The value to set as the data.
    Raises:
...
def next_node(self, value):
    ...
    Args:
        value (Node): The value to set as the next_node.
    Raises:
